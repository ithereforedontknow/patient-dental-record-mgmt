                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" id="officeNo" placeholder="Enter office number" required>
                        </div>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" id="faxNo" placeholder="Enter fax number">
                        </div>
